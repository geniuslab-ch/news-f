...
export default function ProgramSelector() {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-primary-200">
            ...
            {/* Package Selection */}
            <div className="mb-8">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Forfait</h3>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {packages.map((pkg) => (
                        <button
                            key={pkg.id}
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-3xl font-extrabold text-gradient mb-2">CHF {pkg.price}</p>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-lg font-semibold text-primary-600 mt-1">
                            CHF {selected?.price} ({selected?.sessions} sessions)
                        </p>
                    </div>
                    <Link
                        href={`/dashboard/checkout?program=${selectedProgram}&duration=${selectedPackage}`}
