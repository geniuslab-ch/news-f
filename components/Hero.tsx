        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
            ...
            <div className="relative z-10 w-full px-4 pb-20">
                <div className="container mx-auto max-w-4xl text-center">
                    <a
                        href="#signup"
                        className="inline-block bg-gradient-fitbuddy text-white font-bold text-xl px-12 py-5 rounded-full hover:scale-110 transition-all duration-300 shadow-2xl hover:shadow-primary-400/50 btn-shine"
                    >
                        {ctaText}
                    </a>
                </div>
