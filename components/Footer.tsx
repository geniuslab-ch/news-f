            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm">
                            Email:{' '}
                            <a href="mailto:contact@fitbuddy.com" className="text-emerald-400 hover:text-emerald-300 transition">
                                contact@fitbuddy.com
                            </a>
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <a href="/mentions-legales" className="hover:text-emerald-400 transition">
                                    Mentions légales
                                </a>
                            </li>
                            <li>
                                <a href="/politique-confidentialite" className="hover:text-emerald-400 transition">
                                    Politique de confidentialité
                                </a>
                            </li>
                            <li>
                                <a href="/cgv" className="hover:text-emerald-400 transition">
                                    CGV
                                </a>
                            </li>
                        </ul>
